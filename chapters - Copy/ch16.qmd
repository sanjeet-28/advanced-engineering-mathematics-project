...
the integral along $C$ being taken counterclockwise and the other integrals clockwise (as in @fig-16-354 and 355, <!-- TODO: replace Sec. 14.2 with actual cross-reference label -->). We take the integrals over $C_1, \ldots, C_k$ to the right and compensate the resulting minus sign by reversing the sense of integration. Thus,
